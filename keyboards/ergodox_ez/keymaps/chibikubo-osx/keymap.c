...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        // right hand
        KC_RGHT,  KC_6,            KC_7,     KC_8,    KC_9,    KC_0,     KC_LBRC,
        KC_NO,    KC_Y,            KC_U,     KC_I,    KC_O,    KC_P,     KC_RBRC,
                  KC_H,            KC_J,     KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
        KC_NO,    KC_N,            KC_M,     KC_COMM, KC_DOT,  KC_SLSH,  LSFT(KC_MINS),
                  LT(SYMB,KC_P1),  KC_BSPC,  KC_NO,   KC_NO,   KC_NO,
